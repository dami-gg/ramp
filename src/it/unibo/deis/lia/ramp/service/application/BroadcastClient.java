...
public class BroadcastClient extends Thread{
    ...
    public String[] programList(ServiceResponse service) throws Exception{
        ...
        try{
            ...
            //e.printStackTrace();
            System.err.println("BroadcastClient programList service="+service+": "+e.getMessage());
        }
        ...
        public void run(){
            ...
            while(programHandler.active){
                try{
                    ...
                    try{
                        if(RampEntryPoint.logging && this.programHandler.broadcastClientQualityLogFile!=null){
                            /*if(quality == null){
