...
public class BroadcastService extends Thread{
    ...
    private float videoScale = 0.5F;       // ratio
    ...
    public void run(){
        ...
        while(open){
            try{
            	...
            	System.out.println("BroadcastService "+e.getMessage());
            }
        }
...
//                    				",sdp=rtsp://127.0.0.1:"+vlcPort+"/stream.sdp"+
        ...
        public void run(){
            ...
            try{
                if(RampEntryPoint.logging && broadcastServiceLogFileQuality!=null){
        ...
        private RTP qualityTailor(final RTP rtp, EndPoint receiver) throws Exception{
            ...
            /**/
            if(RampEntryPoint.logging && startTailoring!=-1){
