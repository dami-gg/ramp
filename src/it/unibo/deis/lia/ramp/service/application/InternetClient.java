    ...
    public boolean activateLayer3Path(ServiceResponse internetService){
        ...
        try{
            ...
            res = E2EComm.sendUnicast(
                    ...
                    internetService.getSourceNodeId(),
            ...
            try{
                if(availableServices==null || availableServices.size()==0){
                    ...
                    while(line!=null && !line.equals("")){
                        ...
                        if( line.toLowerCase().startsWith("layer4protocol")){
                    ...
                    if( samePath ){
                        // exploit the OS-baed layer-3 multi-hop path
                        System.out.println("\tInternetClient OS-based layer-3 multi-hop path to "+selectedService.getServerDest());
                        responseToTheApplication = InternetUtil.performInternetConnection(ir);
                    }
                    else{
                        // exploit the RAMP-based layer-7 multi-hop path
                        System.out.println("\tInternetClient RAMP-based layer-7 multi-hop path to "+selectedService.getServerDest());

                        // send unicast with default bufferSize
                        //System.out.println("InternetClient sendUnicast");
                        E2EComm.sendUnicast(
                                selectedService.getServerDest(),
                                selectedService.getSourceNodeId(),
                        ...
                        //responseToTheApplication = (byte[])payload;
                    ...
                    synchronized(lock){
                        ...
                        if(RampEntryPoint.logging==true){
