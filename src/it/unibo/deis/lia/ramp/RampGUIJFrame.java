...
/*
 * GUIMonitorJFrame.java
 *
 * Created on 21-ott-2009, 10.22.23
 */
...
public class RampGUIJFrame extends javax.swing.JFrame {
    ...
    /** Creates new form GUIMonitorJFrame */
    public RampGUIJFrame() throws Exception{
        ...
        jCheckBoxLoggingActionPerformed(null);
    ...
    private void initComponents() {
        ...
        jCheckBoxUpnpManager = new JCheckBox();
        jCheckBoxUpnpManager.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
        		jCheckBoxUPnPManagerActionPerformed(arg0);
        	}

			
        });
        jCheckBoxUpnpManager.setText("UPnP Manager");
        	...
        	gl_jPanel2.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_jPanel2.createSequentialGroup()
        			.addGroup(gl_jPanel2.createParallelGroup(Alignment.LEADING)
        				...
        				.addGroup(gl_jPanel2.createSequentialGroup()
        					.addContainerGap()
        					.addComponent(jCheckBoxUpnpManager, GroupLayout.PREFERRED_SIZE, 141, GroupLayout.PREFERRED_SIZE))
        				.addGroup(gl_jPanel2.createSequentialGroup()
        					.addContainerGap()
        ...
        gl_jPanel2.setVerticalGroup(
        	gl_jPanel2.createParallelGroup(Alignment.TRAILING)
        		.addGroup(Alignment.LEADING, gl_jPanel2.createSequentialGroup()
        			...
        			.addComponent(jPanel4, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(jCheckBoxUpnpManager)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(jCheckBoxLayer3RoutingManager)
        ...
        gl_jPanel5.setHorizontalGroup(
        	gl_jPanel5.createParallelGroup(Alignment.TRAILING)
        		.addComponent(jButtonRefreshNeighbors, GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
        		.addComponent(jLabel1, GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
        		.addComponent(jScrollPane1, GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
        		.addComponent(jButtonForceHeartbeat, GroupLayout.DEFAULT_SIZE, 230, Short.MAX_VALUE)
        );
        ...
        gl_jPanel9.setHorizontalGroup(
        	gl_jPanel9.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_jPanel9.createSequentialGroup()
        			.addContainerGap()
        			.addComponent(jCheckBoxLogging)
        			.addPreferredGap(ComponentPlacement.RELATED, 44, Short.MAX_VALUE)
        			.addComponent(jLabelLogging)
        			.addContainerGap())
        );
        gl_jPanel9.setVerticalGroup(
        	gl_jPanel9.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_jPanel9.createSequentialGroup()
        			.addGroup(gl_jPanel9.createParallelGroup(Alignment.BASELINE)
        				.addComponent(jCheckBoxLogging)
        				.addComponent(jLabelLogging, GroupLayout.PREFERRED_SIZE, 14, GroupLayout.PREFERRED_SIZE))
        		...
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        				...
        				.addGroup(layout.createSequentialGroup()
        					.addComponent(jPanel3, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(jPanel9, GroupLayout.PREFERRED_SIZE, 32, GroupLayout.PREFERRED_SIZE)
        					.addGap(11)
        					.addComponent(jPanel8, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(jPanel7, GroupLayout.PREFERRED_SIZE, 267, GroupLayout.PREFERRED_SIZE)
        				.addComponent(jPanel2, GroupLayout.PREFERRED_SIZE, 267, GroupLayout.PREFERRED_SIZE))
        			.addGap(10))
        );
    ...
    private void jButtonRefreshNeighborsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRefreshNeighborsActionPerformed
        try{
            String text="";
            Vector<InetAddress> neighbors = ramp.getCurrentNeighbors();
            for(int i=0; i<neighbors.size(); i++){
                text=text+i+" "+neighbors.elementAt(i)+"\n";
            }
    ...
    private void jCheckBoxUPnPManagerActionPerformed(ActionEvent arg0) {
		boolean selected =this.jCheckBoxUpnpManager.getModel().isSelected();
		if(selected)
    ...
    private void jCheckBoxLoggingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBoxLoggingActionPerformed
        boolean selected = this.jCheckBoxLogging.getModel().isSelected();
        if(selected){
            RampEntryPoint.logging = true;
        }
        else{
            RampEntryPoint.logging = false;
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try{
                    new RampGUIJFrame().setVisible(true);
                }
                catch(Exception e){
                    e.printStackTrace();
                }
    ...
    private JCheckBox jCheckBoxUpnpManager;
}
